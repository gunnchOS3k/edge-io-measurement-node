# WAIKE Integration — edge-io-measurement-node
...
Topics indexed in `waike-research-ops/knowledge_maps/waike_skill_tree.yaml` with repo link `edge-io-measurement-node`.
