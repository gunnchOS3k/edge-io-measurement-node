#!/usr/bin/env python3
"""Verify E2E required files exist for edge-io-measurement-node."""
...
REQUIRED = [
    ...
    "Makefile",
    "results/e2e/synthetic_telemetry.json",
    "results/e2e/seven_gc_export.json",
]
...
def main():
    ...
    if "End-to-End Research Artifact" not in readme:
        ...
        return 1
    print("PASS all required E2E artifacts for edge-io-measurement-node")
    return 0
