        # Reproducibility — Edge-IO Measurement Node
...
# Expected: CI smoke pass; tests pass or documented skip
        ...
        **Real today:** Schema validation, sample telemetry, probe modules, tests

        **Synthetic / demo-only:** Emulator-generated telemetry streams

        **Planned:** Android APK, field campaign exports

        **Not claimed:** Carrier-grade monitoring, private payload collection
